...
class IpPolicy
{
    ...
    {
        return $user->can('force_delete_ip');
    }
    ...
    {
        return $user->can('force_delete_any_ip');
    }
    ...
    {
        return $user->can('restore_any_ip');
    }
